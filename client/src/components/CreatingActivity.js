...
const CreatingActivity = () => {
  ...
  const [difficultyAndSeason, setDifficulyAndSeason] = useState({
    difficulty: null,
    season: "",
  });
  ...
  const handleSubmit = (e) => {
    ...
    if (
      name.validate === "true" &&
      url.validate === "true" &&
      duration.validate === "true" &&
      difficultyAndSeason.season &&
      difficultyAndSeason.difficulty
    ) {
      setValidate(true);
      dispatch(
        postActivity({
    ...
    <div className="formActDiv">
      ...
      <div className="container">
        <Formulario onSubmit={handleSubmit}>
          ...
          <ButtonCenter>
            <Button type="submit">
              <ion-icon name="chevron-up-circle-outline"></ion-icon>Save
            </Button>
            {validate === true && (
